...
- 当前仍不是完整 production IBL；已具备最小 HDR scene color readback / statistical frame validation，但尚缺完整 screenshot/golden image 验证、tone-mapped LDR readback、球体材质视觉 fixture、public quality config API、shadow、多光源、bloom 或 auto exposure。
